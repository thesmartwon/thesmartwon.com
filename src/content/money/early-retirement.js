...
export default () => (
  <PostTemplate data={{markdownRemark}}>
    ...
    <p>Don't believe me? Let's do the math.</p>
    <RetirementCalc />
    <h2>The Catch</h2>
    <p>The biggest catch is that you're betting on the US economy.
      ...
      500 largest U.S. publicly traded companies by market value.</p>
    <h3>$24k/year</h3>
    <p>This isn't an unrealistic budget,
      ...
      for you to minimize. If you were to live off $34k/year instead, it would take 15 years and a nest egg of over $1mil to retire!</p>
    <p>You need a budget. Frugality will pay off. If you have one particulary bad area of spending, as chef Ramsay says,
      {' '}<a href="https://www.youtube.com/watch?v=BsFeplo_6Pg">wake up!</a></p>
    <Image src={wakeUp} height={338} alt="Wake up!" />
    ...
    <p>This is the rate you can withdraw from your investments per-year for the entire rest of your life while feeling "safe"
      ...
      time horizon to sooner and use a higher percentage such as 4% or 6%.</p>
    ...
    <p>To adjust for rising living expenses from inflation, we assume a high inflation rate of 3%. We calculate our investments growing
      ...
      <Link href="https://tradingeconomics.com/united-states/inflation-cpi"> here.</Link></p>
    ...
    <p>HSAs are tax deductable, and earnings are tax-exempt. Withdrawals from a health savings account are tax-free as long you
      ...
      your employer, usually along with a high-deductable medical plan. The contribution limit is $3450 for 2018, and was $3400 for 2017.</p>
    ...
    <p>401k plans vary per-employer, but the gist is that you can contribute up to $18,000 of tax-deductable income per-year.
      ...
      <Link href="http://www.gcbaonline.com/retirement/understanding-irs-72t-withdraws-rule-calculator"> rule 72t </Link></p>
