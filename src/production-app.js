...
import {
  ...
  RouteUpdates,
} from "../.cache/navigation"
import emitter from "../.cache/emitter"
import PageRenderer from "../.cache/page-renderer"
...
import EnsureResources from "../.cache/ensure-resources"
...
apiRunnerAsync(`onClientEntry`).then(() => {
  ...
  if (apiRunner(`registerServiceWorker`).length > 0) {
    require(`../.cache/register-service-worker`)
  }
